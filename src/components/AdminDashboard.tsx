...
import { ExpertModeContent } from "./dashboard/ExpertModeContent";
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 md:px-10 md:py-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className={`p-3 rounded-2xl transition-all group mr-2 ${isExpertModeOpen ? 'bg-[#00FFA3]/20 text-[#00FFA3]' : 'bg-black/5 text-gray-900/60 hover:text-[#00FFA3]'}`}
                    title="Expert Command Centre"
                  >
            ...
            >
                <ExpertModeContent 
                    ...
                    setIsAutoTagMenuOpen={setIsAutoTagMenuOpen}
                />
            </ExpertModeDrawer>
