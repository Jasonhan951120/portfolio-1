                                ...
                                <div className={`${activeTab === 'reputation' ? 'max-w-none w-full !px-4' : 'max-w-4xl mx-auto'}`}>
                                    ...
                                    {activeTab === 'menu' && (
                                        <div className="space-y-4 animate-in fade-in zoom-in-95 duration-700">
                                            ...
                                            {/* [FINAL LUXURY REFACTOR]: 3x2 Symmetric 2-Photo Grid */}
                                            <div className="w-full !max-w-none">
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full mb-20">
                                                    {templates.map(template => (
                                                        <div key={template.id} className={`${cardBg} rounded-[2.5rem] border ${borderColor} p-4 shadow-luxury hover:shadow-2xl transition-all duration-700 group relative overflow-hidden flex flex-col bg-white h-[350px]`}>
                                                        
                                                        <div className="flex-1 space-y-3 relative z-10">
                                                            <div className="relative">
                                                                <h4 className={`text-[#111827] font-serif font-bold text-base tracking-tight leading-tight capitalize truncate`}>
                                                            ...
                                                            <div className="flex items-center justify-between pt-1.5 border-t border-slate-50">
                                                                <div>
                                                                    <p className="text-[#111827] font-bold text-xl tracking-tighter flex items-center gap-0.5">
                                                            ...
                                                            {/* Symmetric Photo Alignment: 1 Pre, 1 Post (1:1 Layout) */}
                                                            <div className="flex flex-row justify-center gap-4 pt-3">
                                                                {/* Pre Slot */}
                                                                <div className="space-y-1.5">
                                                                    <span className="text-[10px] font-bold text-[#374151] uppercase tracking-[0.2em] text-center block whitespace-nowrap">PRE</span>
                                                                    <div 
                                                                        onClick={() => document.getElementById(`upload-before-${template.id}`)?.click()}
                                                                        className={`w-28 h-28 rounded-2xl border-2 border-dashed border-slate-100 hover:border-emerald-300 bg-slate-50/30 flex items-center justify-center shadow-inner cursor-pointer transition-all overflow-hidden group/img shrink-0`}
                                                                    >
                                                                        {template.beforeImg ? (
                                                                            ...
                                                                            <div className="flex flex-col items-center gap-1.5 px-2">
                                                                                ...
                                                                                <span className="text-[10px] font-medium text-slate-400 uppercase tracking-tight text-center leading-tight whitespace-nowrap">Upload Photo</span>
                                                                            </div>
                                                                        )}
                                                                ...
                                                                {/* Post Slot */}
                                                                <div className="space-y-1.5">
                                                                    <span className="text-[10px] font-bold text-[#374151] uppercase tracking-[0.2em] text-center block whitespace-nowrap">POST</span>
                                                                    <div 
                                                        ...
                                                        {/* Luxury Footer Actions & Branding */}
