...
export function ClinicSettings({ 
    ...
    const accentColor = isDark ? 'text-[#78dcca]' : 'text-[#78dcca]'; // Mint green for both as per request
    const iconAccent = isDark ? 'text-[#78dcca]' : 'text-[#78dcca]';
    const cardBg = isDark ? 'bg-white' : 'bg-white';
    const sidebarActiveBg = isDark ? 'bg-white' : 'bg-white';
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9000] flex items-center justify-center bg-[#0f172a]/40 backdrop-blur-xl p-4 md:p-8">
                    <motion.div
                        ...
                        className={`w-full max-w-6xl h-full max-h-[88vh] ${bgColor} rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden border border-white/40 ring-1 ring-black/5 transition-colors duration-500`}
                    >
                        {/* Header */}
                        <div className="flex-shrink-0 px-10 py-8 flex items-center justify-between border-b border-black/[0.03]">
                            <div className="flex items-center gap-5">
                                <div className={`w-14 h-14 rounded-2xl bg-white border border-black/[0.03] flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] relative`}>
                                    <Settings className={`w-7 h-7 ${textColor}`} strokeWidth={1.2} />
                                ...
                                <div className="font-inter tracking-tight">
                                    <h2 className={`text-3xl font-black ${textColor} mb-1`}>Clinic Settings</h2>
                                    <div className="flex items-center gap-2">
                                        <span className={`text-[10px] font-bold uppercase tracking-[0.2em] ${iconAccent}`}>Executive Protocol</span>
                            ...
                            <div className="w-72 flex-shrink-0 border-r border-black/[0.03] p-8 flex flex-col gap-3 font-inter tracking-tight">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <List className={`w-5 h-5 ${activeTab === 'menu' ? iconAccent : 'text-slate-300'}`} strokeWidth={activeTab === 'menu' ? 2.5 : 2} />
                                ...
                                >
                                    <Globe className={`w-5 h-5 ${activeTab === 'general' ? iconAccent : 'text-slate-300'}`} strokeWidth={activeTab === 'general' ? 2.5 : 2} />
                                ...
                                >
                                    <User className={`w-5 h-5 ${activeTab === 'support' ? iconAccent : 'text-slate-300'}`} strokeWidth={activeTab === 'support' ? 2.5 : 2} />
                                    <span className="font-bold text-base">Support & Help</span>
                                </button>
                            </div>

                            {/* Main Configuration Panel */}
                            <div className={`flex-1 overflow-y-auto p-12 custom-scrollbar ${isDark ? 'bg-white/40' : 'bg-white/20'} transition-colors duration-500`}>
                                <div className="max-w-4xl mx-auto font-inter tracking-tight">
                                        ...
                                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                                            <div className="mb-12 p-10 bg-white border border-black/[0.03] rounded-[2.5rem] shadow-[0_10px_40px_rgba(0,0,0,0.02)] relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.05] transition-opacity">
                                                    <Briefcase className={`w-32 h-32 ${textColor}`} />
                                                </div>
                                                <div className="flex items-center gap-3 mb-2">
                                                    <h3 className={`text-2xl font-black ${textColor}`}>Clinic Industry</h3>
                                                ...
                                                <div className="relative max-w-sm group">
                                                    <select 
                                                        ...
                                                        className={`w-full bg-white border border-black/[0.06] rounded-2xl py-4 px-6 text-base font-bold ${textColor} focus:outline-none focus:ring-4 focus:ring-[#78dcca]/10 focus:border-[#78dcca] transition-all appearance-none cursor-pointer shadow-sm`}
                                                    >
                                                        <option value="Dental">Dental Clinic</option>
                                                        <option value="Aesthetic">Aesthetic Clinic</option>
                                                        <option value="Wellness">Wellness & Spa</option>
                                                    </select>
                                                    <div className={`absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none ${iconAccent}`}>
                                            ...
                                            <div className="flex items-center justify-between mb-10">
                                                <div>
                                                    <div className="flex items-center gap-3 mb-1">
                                                        <h3 className={`text-2xl font-black ${textColor}`}>Treatment Menu Builder</h3>
                                                        <div className="w-2 h-2 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]" />
                                                    </div>
                                                ...
                                                >
                                                    <Plus className={`w-5 h-5 ${iconAccent}`} strokeWidth={3} /> Add New Treatment
                                                </button>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                    ...
                                                    <div key={template.id} className={`group bg-white rounded-[2rem] border border-black/[0.03] shadow-sm hover:shadow-[0_20px_50px_rgba(0,0,0,0.06)] hover:border-[#78dcca]/40 transition-all duration-500 p-8 relative overflow-hidden flex flex-col h-full ring-1 ring-black/[0.01]`}>
                                                        <div className="flex justify-between items-start mb-6">
                                                            <div className="flex-1">
                                                                <h4 className={`${textColor} font-black text-lg truncate mb-1 pr-8`}>{template.name}</h4>
                                                                <p className={`${accentColor} font-black text-xl tracking-tight`}>{currency}{template.price.toLocaleString()}</p>
                                                            </div>
                                                            <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-all absolute top-6 right-6 translate-y-2 group-hover:translate-y-0">
                                                                <button 
                                                                    ...
                                                                    className={`w-9 h-9 flex items-center justify-center text-slate-400 hover:${iconAccent} bg-slate-50 hover:bg-[#78dcca]/5 rounded-xl transition-all`}
                                                                >
                                                ...
                                                >
                                                    <div className="w-14 h-14 rounded-2xl bg-white shadow-lg border border-black/[0.02] flex items-center justify-center group-hover:scale-110 transition-transform mb-4">
                                                        <Plus className={`w-6 h-6 ${iconAccent}`} strokeWidth={3} />
                                                    </div>
                                    ...
                                    {activeTab === 'general' && (
                                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-10">
                                            <div className="flex items-center gap-3 mb-2">
                                                <h3 className={`text-3xl font-black ${textColor}`}>Branding Identity Suite</h3>
                                                <div className="w-2 h-2 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.5)]" />
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 gap-10">
                                                ...
                                                <div className="p-10 bg-white border border-black/[0.03] rounded-[2.5rem] shadow-sm hover:shadow-[0_15px_40px_rgba(0,0,0,0.03)] transition-all">
                                                    <div className="flex items-start gap-6 mb-10">
                                                        <div className="w-16 h-16 rounded-[1.5rem] bg-[#78dcca]/5 border border-[#78dcca]/10 flex items-center justify-center shadow-inner">
                                                            <Globe className={`w-8 h-8 ${iconAccent}`} />
                                                        </div>
                                                        <div className="flex-1">
                                                            <h4 className={`text-xl font-black ${textColor} mb-2`}>Global Synchronisation & Locale</h4>
                                                    ...
                                                    <div className="relative max-w-sm">
                                                        <select 
                                                            ...
                                                            className={`w-full bg-[#f8f9fa] border border-black/[0.04] rounded-2xl py-[1.125rem] px-6 text-base font-bold ${textColor} focus:outline-none focus:ring-4 focus:ring-[#78dcca]/10 focus:border-[#78dcca] transition-all appearance-none cursor-pointer`}
                                                        >
                                                ...
                                                <div className="p-10 bg-white border border-black/[0.03] rounded-[2.5rem] shadow-sm hover:shadow-[0_15px_40px_rgba(0,0,0,0.03)] transition-all">
                                                    <div className="flex items-start gap-6 mb-10">
                                                        <div className="w-16 h-16 rounded-[1.5rem] bg-[#78dcca]/5 border border-[#78dcca]/10 flex items-center justify-center shadow-inner">
                                                            <Zap className={`w-8 h-8 ${iconAccent}`} />
                                                        </div>
                                                        <div className="flex-1">
                                                            <h4 className={`text-xl font-black ${textColor} mb-2`}>Brand Aesthetics & Interface</h4>
                                                            <p className="text-base text-slate-500 leading-relaxed font-medium">
                                                    ...
                                                    <div className="flex gap-4">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`flex-1 py-4 px-6 rounded-2xl font-black text-sm uppercase tracking-widest transition-all duration-300 border-2 ${
                                                                activeTheme === 'dark' 
                                                                    ? `bg-white ${accentColor} border-[#78dcca] shadow-lg` 
                                                ...
                                                <div className="p-10 bg-white border border-black/[0.03] rounded-[2.5rem] shadow-sm hover:shadow-[0_15px_40px_rgba(0,0,0,0.03)] transition-all">
                                                    <div className="flex items-start gap-6 mb-10">
                                                        <div className="w-16 h-16 rounded-[1.5rem] bg-[#78dcca]/5 border border-[#78dcca]/10 flex items-center justify-center shadow-inner">
                                                            <MessageSquare className={`w-8 h-8 ${iconAccent}`} />
                                                        </div>
                                                        <div className="flex-1">
                                                            <h4 className={`text-xl font-black ${textColor} mb-2`}>Patient Communication Tone</h4>
                                                            <p className="text-base text-slate-500 leading-relaxed font-medium">
                                        ...
                                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-12 pb-10">
                                            <div className="text-center max-w-2xl mx-auto mb-16">
                                                <div className="flex items-center justify-center gap-4 mb-4">
                                                    <h3 className={`text-4xl font-black ${textColor} tracking-tight`}>Executive Wellness Concierge</h3>
                                                </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                                ...
                                                <div className="bg-white border border-black/5 rounded-[2.5rem] p-10 shadow-sm hover:shadow-[0_20px_60px_rgba(0,0,0,0.04)] transition-all flex flex-col relative group overflow-hidden">
                                                    <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
                                                        <User className={`w-24 h-24 ${textColor}`} />
                                                    </div>
                                                    <div className="w-14 h-14 rounded-2xl bg-[#78dcca]/10 flex items-center justify-center mb-8 shadow-inner ring-1 ring-[#78dcca]/20">
                                                        <User className={`w-7 h-7 ${iconAccent}`} />
                                                    </div>
                                                    <h4 className={`text-xl font-black ${textColor} mb-5`}>24/7 Executive Concierge</h4>
                                                    <p className="text-base text-slate-500 leading-relaxed font-medium">
                                                ...
                                                <div className="bg-white border border-black/5 rounded-[2.5rem] p-10 shadow-sm hover:shadow-[0_20px_60px_rgba(0,0,0,0.04)] transition-all flex flex-col relative group overflow-hidden">
                                                    <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
                                                        <ShieldCheck className={`w-24 h-24 ${textColor}`} />
                                                    </div>
                                                    <div className="w-14 h-14 rounded-2xl bg-[#78dcca]/10 flex items-center justify-center mb-8 shadow-inner ring-1 ring-[#78dcca]/20">
                                                        <ShieldCheck className={`w-7 h-7 ${iconAccent}`} />
                                                    </div>
                                                    <h4 className={`text-xl font-black ${textColor} mb-5`}>Trust & Compliance Vault</h4>
                                                    <p className="text-base text-slate-500 leading-relaxed font-medium">
                                                ...
                                                <div className="bg-white border border-black/5 rounded-[2.5rem] p-10 shadow-sm hover:shadow-[0_20px_60px_rgba(0,0,0,0.04)] transition-all flex flex-col relative group overflow-hidden">
                                                    <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
                                                        <Zap className={`w-24 h-24 ${textColor}`} />
                                                    </div>
                                                    <div className="w-14 h-14 rounded-2xl bg-[#78dcca]/10 flex items-center justify-center mb-8 shadow-inner ring-1 ring-[#78dcca]/20">
                                                        <Zap className={`w-7 h-7 ${iconAccent}`} strokeWidth={2.5} />
                                                    </div>
                                                    <h4 className={`text-xl font-black ${textColor} mb-5`}>Strategic Partnership & Insights</h4>
                                                    <p className="text-base text-slate-500 leading-relaxed font-medium">
