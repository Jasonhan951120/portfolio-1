...
function HotLeadCard({
    ...
    return (
        ...
        >
            ...
            <div
                className={`
                    relative w-full bg-[#1E1E1E] rounded-[44px] sm:rounded-[56px] p-6 sm:p-10
                ...
                <div className="relative z-10 space-y-3 mt-auto">
                    <motion.button
                        ...
                        className={`
                            ...
                            transition-all duration-600 flex items-center justify-center gap-3 text-xs sm:text-sm
                            ${sent
