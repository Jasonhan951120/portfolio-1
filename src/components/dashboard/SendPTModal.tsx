        ...
        >
          ...
          <div className="px-8 py-10 space-y-8">
            <div className="space-y-6">
              <div>
                 <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Final Treatment Price</label>
              ...
              <div>
                 <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Personalized Note</label>
                 <textarea 
                    ...
                    placeholder="e.g. Great seeing you today, James! Looking forward to starting your smile transformation."
                 />
              </div>
            </div>
          </div>
