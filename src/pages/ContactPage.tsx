                                ...
                                {status === "success" ? (
                                    ...
                                    <motion.form key="form" onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input required type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full bg-[#FBFBFB] border border-black/5 rounded-2xl px-6 py-4 focus:border-primary focus:outline-none transition-all font-bold" placeholder="demo@example.com" />
                                        </div>
                                        <div className="space-y-2">
